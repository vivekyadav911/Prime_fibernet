...
const styles = StyleSheet.create({
  ...
  sortPillActive: { backgroundColor: adminColors.primary, borderColor: adminColors.primary },
  sortPillText: { fontSize: 13, color: colors.textSecondary },
  ...
  tabActiveSent: { backgroundColor: adminColors.notificationHub.sentTabBg },
