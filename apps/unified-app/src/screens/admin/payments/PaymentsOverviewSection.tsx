    ...
    <SectionCard title="Payments overview">
      ...
      {isLoading || !kpis ? (
        ...
        <View style={styles.kpiGrid}>
          ...
          <AdminKPICard label="Collected today" value={formatINR(kpis.collected_today)} icon="✅" surface="teal" status="healthy" />
          <Pressable style={styles.kpiPressable} onPress={onFilterPendingReview}>
            <AdminKPICard
